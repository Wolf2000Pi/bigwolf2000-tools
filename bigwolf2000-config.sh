...
calc_wt_size
while true; do
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 " 
  --menu "Setup Options"  $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Beenden --ok-button Wählen \
