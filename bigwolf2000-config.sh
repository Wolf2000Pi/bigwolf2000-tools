...
do_Grund_optionen_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Grund-optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenü --ok-button Wählen \
...
do_Openmediavault_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Openmediavault Optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu --ok-button Wählen \
...
#CPU Temp OMV
  ...
  do_cputemp_menu() {
  FUN=$(whiptail --title "CPU Temp OMV" --menu "Bitte wählen sie aus" 12 35 5 --cancel-button Hauptmenü --ok-button Wählen \
     "OT1 Bitte Lesen" "" \
	 "OT2 Installieren" "" \
	 "OT3 Config CPU Temp" "" \
	 "OT4 Deinstallieren" "" \
...
openmediavault-cputemp 6.1.2
Lm-Sensors istalliert und sensors-detect ausgeführt sein.
1. Installieren
2. Config aus zwischen Intel & AMD
...
#Programme
do_programme_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Programme installieren" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu --ok-button Wählen \
...
#Docker
do_docker_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Docker Optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu \
...
#Advanced
do_advanced_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Advanced Options" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu \
...
calc_wt_size
while true; do
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.1.0" --menu "Hauptmenu"  $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Beenden --ok-button Wählen \
