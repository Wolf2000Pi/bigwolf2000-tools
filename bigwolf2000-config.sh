...
do_Grund_optionen_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Grund-optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenü --ok-button Wählen \
...
do_Openmediavault_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Openmediavault Optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu --ok-button Wählen \
...
#Programme
do_programme_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Programme installieren" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu --ok-button Wählen \
...
#Docker
do_docker_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Docker Optionen" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu \
...
#Advanced
do_advanced_menu() {
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Advanced Options" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Hauptmenu \
...
calc_wt_size
while true; do
  FUN=$(whiptail --title "Server Software Configuration Tool Bigwolf2000 Version 3.2.0" --menu "Hauptmenu"  $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT --cancel-button Beenden --ok-button Wählen \
